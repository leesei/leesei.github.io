...
[Crypto Guides for Beginners and Veterans | Crypto.com University](https://crypto.com/university)
[You searched for Blockchain 2.0 - OSTechNix](https://ostechnix.com/?s=Blockchain+2.0)
...
> see [[distributed-computing#Consensus Mechanisms]]

[The Beginner's Guide to Consensus Mechanisms - Blockworks](https://blockworks.co/news/consensus-mechanisms-guide)
...
[Enabling Blockchain Innovations with Pegged Sidechains](https://blockstream.com/sidechains.pdf) PDF
...
[Sidechains: Highlights and Challenges](https://www.researchgate.net/publication/335368901_Sidechains_Highlights_and_Challenges) PDF

[Why is Interoperability Needed? – Hyperledger Foundation](https://www.hyperledger.org/blog/2022/02/02/why-is-interoperability-needed)
[The Opportunity for Interoperable Chains of Chains - CoinDesk](https://www.coindesk.com/markets/2018/01/27/the-opportunity-for-interoperable-chains-of-chains/)
...
[Extropy - Blockchain Consultancy - Tutorials - Training - Development](https://www.extropy.io/)
[extropy - YouTube](https://www.youtube.com/@extropy_io)
...
[元宇宙致命的10個問題：虛擬土地還有戲嗎？ | 動區動趨-最具影響力的區塊鏈新聞媒體](https://www.blocktempo.com/ten-questions-of-metaverse/)
...
[The Web3 Stack: Reference for Developers - Geekflare](https://geekflare.com/web3-stack-for-developers/)
...
[Vision Pro、Quest 3與元宇宙無關？a16z 解釋元宇宙為何一定要有Web3](https://abmedia.io/7-essential-ingredients-of-a-metaverse)
...
[dabit3/perma: Perma is a web3 prototype of permanent video storage and viewing using Next.js, Arweave, and Bundlr.](https://github.com/dabit3/perma)
...
[Understanding DIDComm. A cross-community effort to standardize… | by Kaliya-IdentityWoman | Decentralized Identity Foundation | Medium](https://medium.com/decentralized-identity/understanding-didcomm-14da547ca36b)
...
[UCAN Distributed Auth](https://ucan.xyz/)
[ucan-wg/spec: User Controlled Authorization Network (UCAN) Specification](https://github.com/ucan-wg/spec)

[Intro to UCAN](https://blog.web3.storage/posts/intro-to-ucan)
[Feature release: UCAN-signed uploads](https://blog.nft.storage/posts/2022-04-01-gateway-ucan-release)
[Yes, UCAN](https://twit.tv/shows/floss-weekly/episodes/681)

[The future of identity, data, and compute – Fission](https://fission.codes/)
[UCAN: Authorizing Users Without a Back End – Fission](https://fission.codes/blog/auth-without-backend/)

[Use UCAN tokens for delegated authorization](https://nft.storage/docs/how-to/ucan/)

### MetaMask

[The Ultimate Crypto Wallet for DeFi, Web3 Apps, and NFTs | MetaMask](https://metamask.io/)

[MetaMask Tutorial: One-click Login With Blockchain Made Easy | Toptal®](https://www.toptal.com/ethereum/one-click-login-flows-a-metamask-tutorial)
[What is MetaMask Wallet? How to Set up a MetaMask Wallet](https://www.coindesk.com/learn/how-to-set-up-a-metamask-wallet/)
...
[giekaton/php-metamask-user-login: Web3 passwordless user login with MetaMask and PHP](https://github.com/giekaton/php-metamask-user-login)
[MetaMask/React-MetaMask-Login-Button](https://github.com/MetaMask/React-MetaMask-Login-Button)
...
[Worldcoin：引入零知識證明可保護用戶隱私，但社群揭露一缺陷.. | 動區動趨-最具影響力的區塊鏈新聞媒體](https://www.blocktempo.com/worldcoin-says-zero-knowledge-proof-can-protect-human-biological-privacy/)
