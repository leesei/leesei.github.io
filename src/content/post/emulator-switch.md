...
Update/DLC: "File" > "Install Files to NAND"
...
Sonic Colors: Ultimate v1.0.9+6DLC
Sonic Forces v1.1.0+6DLC
...
Kirby Star Allies v4.0.0 (co-op)
...
7 Billion Humans (Programming)
DORAEMON STORY OF SEASONS
Game Builder Garage (Programming)
Graveyard Keeper v1.0.0.4633+3DLC
Let's Build A Zoo v1.0.6+1DLC
...
[SciresM/hactool: hactool is a tool to view information about, decrypt, and extract common file formats for the Nintendo Switch, especially Nintendo Content Archives.](https://github.com/SciresM/hactool)

[Tinfoil](https://tinfoil.io/)
[dbi/README_ENG.md at main · rashevskyv/dbi · GitHub](https://github.com/rashevskyv/dbi/blob/main/README_ENG.md)

[nicoboss/nsz: NSZ - Homebrew compatible NSP/XCI compressor/decompressor](https://github.com/nicoboss/nsz)

### Sync Saves

[[cloud-backup#Syncthing]]
