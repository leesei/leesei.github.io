...
[PKI Consortium - YouTube](https://www.youtube.com/@PKIConsortium)
...
[密码学学习笔记*06*数字证书与PKI - 知乎](https://zhuanlan.zhihu.com/p/563337960)
...
[X.680 : Information technology - Abstract Syntax Notation One (ASN.1): Specification of basic notation](https://www.itu.int/rec/T-REC-X.680)
[ASN.1 - Wikiwand](https://www.wikiwand.com/en/articles/ASN.1)
[ASN.1 Made Simple - Introduction](https://www.oss.com/asn1/resources/asn1-made-simple/introduction.html)
[RFC 6025 - ASN.1 Translation](https://datatrackerP.ietf.org/doc/html/rfc6025)

[RFC 5911 - New ASN.1 Modules for Cryptographic Message Syntax (CMS) and S/MIME](https://datatracker.ietf.org/doc/html/rfc5911)
[RFC 5912 - New ASN.1 Modules for the Public Key Infrastructure Using X.509 (PKIX)](https://datatracker.ietf.org/doc/html/rfc5912)

```sh
# `-i` for indent
openssl asn1parse -in ./ssl/rootCA.pem -i
```

## PKI

The **authentication** of server relied on Certificate Authorities (CA) and a public key infrastructure using [X.509](https://www.wikiwand.com/en/X.509) certificates.
...
[PKI Consortium - YouTube](https://www.youtube.com/@PKIConsortium)
[Asia PKI Consortium](https://www.asiapki.org/index.html)
...
[Survival Guide - TLS/SSL and SSL (X.509) Certificates (CA-signed and Self-Signed)](https://www.zytrax.com/tech/survival/ssl.html) ❗!important
...
[draft-ietf-lamps-certdiscovery-02 - A Mechanism for X.509 Certificate Discovery](https://datatracker.ietf.org/doc/draft-ietf-lamps-certdiscovery/) using Subject Information Access (SIA) extension to link to another, potentially PQC, cert
...
[RFC 4055 - Additional Algorithms and Identifiers for RSA Cryptography for use in the Internet X.509 Public Key Infrastructure Certificate and Certificate Revocation List (CRL) Profile](https://datatracker.ietf.org/doc/html/rfc4055)
[RFC 5480 - Elliptic Curve Cryptography Subject Public Key Information](https://datatracker.ietf.org/doc/html/rfc5480)
[RFC 5756 - Updates for RSAES-OAEP and RSASSA-PSS Algorithm Parameters](https://datatracker.ietf.org/doc/html/rfc5756)
...
[RFC 8692 - Internet X.509 Public Key Infrastructure: Additional Algorithm Identifiers for RSASSA-PSS and ECDSA Using SHAKEs](https://datatracker.ietf.org/doc/html/rfc8692)
[Simple Certificate Enrollment Protocol - Wikiwand](https://www.wikiwand.com/en/articles/Simple_Certificate_Enrollment_Protocol)
[RFC 8894 - Simple Certificate Enrolment Protocol](https://datatracker.ietf.org/doc/html/rfc8894)
[SCEP](https://www.ietf.org/proceedings/69/slides/pkix-3.pdf)
...
TODO: Web PKI, Decentralized PKI

### Certificate Transparency (CT)

[Certificate Transparency - Wikiwand](https://www.wikiwand.com/en/articles/Certificate_Transparency)
[How CT Works : Certificate Transparency](https://certificate.transparency.dev/howctworks/) the issuance of cert is accompanied by a Signed Certificate Timestamps (SCT) record on blockchain, adds two intermediate CA
...
[RFC 9162 - Certificate Transparency Version 2.0](https://datatracker.ietf.org/doc/html/rfc9162) deprecates RFC 6962
...
[google/trillian: A transparent, highly scalable and cryptographically verifiable data store.](https://github.com/google/trillian/) maintenance mode
[transparency-dev/tessera: Go library for building tile-based transparency logs (tlogs)](https://github.com/transparency-dev/tessera)
...
> OCSP is made optional and CRL is required again in 2023
...
[RFC 6961 - The Transport Layer Security (TLS) Multiple Certificate Status Request Extension](https://datatracker.ietf.org/doc/html/rfc6961) reducing traffic
...
Reducing TLS handshake size:
[draft-ietf-tls-cert-abridge - Abridged Compression for WebPKI Certificates](https://datatracker.ietf.org/doc/html/draft-ietf-tls-cert-abridge)
[draft-kampanakis-tls-scas-latest - Suppressing CA Certificates in TLS 1.3](https://datatracker.ietf.org/doc/html/draft-kampanakis-tls-scas-latest)

[Common CA Database by the Linux Foundation](https://www.ccadb.org/) root and intermediate CA build in Root Store Operators (browsers)
...
[Certificate management](https://docs.digicert.com/en/device-trust-manager/certificate-management.html)

[Comparing CMP, SCEP, EST & ACME for Certificate Management](https://www.codegic.com/choosing-the-right-cert-management-protocol/)
[Unsung PKI Insights | Certificate Management Protocols: CMP vs ACME vs EST vs SCEP Compared](https://www.unsungltd.com/blog-posts/certificate-management-protocols-cmp-acme-est-and-scep-compared-unsung)

### Enrollment over Secure Transport (EST)

[RFC 7030 - Enrollment over Secure Transport](https://datatracker.ietf.org/doc/html/rfc7030)

- designed for secure device onboarding and IoT
- strong security with mTLS
- supports CA chain distribution & secure key wrapping

[Enrollment over Secure Transport (EST)](https://docs.digicert.com/en/device-trust-manager/get-started/concepts/enrollment-over-secure-transport--est-.html)

### Certificate Management Protocol (CMP)

[RFC 9810 - Internet X.509 Public Key Infrastructure -- Certificate Management Protocol (CMP)](https://datatracker.ietf.org/doc/html/rfc9810) CMP

### Simple Certificate Enrolment Protocol (SCEP)

[RFC 8894 - Simple Certificate Enrolment Protocol](https://datatracker.ietf.org/doc/html/rfc8894)

- designed for network devices (routers, switches) and mobile device management (MDM)
- uses shared secrets → weaker security model
- supports RSA and ECC only (not PQC ready)

[Simple Certificate Enrollment Protocol (SCEP)](https://docs.digicert.com/en/device-trust-manager/get-started/concepts/simple-certificate-enrollment-protocol--scep-.html)
...
- designed for cloud, Kubernetes, CI/CD
- supports short‑lived certs
...
[Automated Certificate Management Environment Protocol (ACME)](https://docs.digicert.com/en/device-trust-manager/get-started/concepts/acme---automated-certificate-management-environment-protocol.html)
...
Look for `<iframe>` to view the video without submitting info
[47-Day Reality Check: How to Prepare for the Certificate Automation Shift](https://www.cyberark.com/resources/webinars/47-day-reality-check-how-to-prepare-for-the-certificate-automation-shift)
[47-Day Chaos to Control: How to Scale Certificate Automation Before Enforcement Hits](https://www.cyberark.com/resources/webinars/47-day-chaos-to-control-how-to-scale-certificate-automation-before-enforcement-hits)
...
BER: Basic Encoding Rules according to ASN.1
...
[tls - What's the difference between X.509 and PKCS#7 Certificate? - Information Security Stack Exchange](https://security.stackexchange.com/questions/73156/whats-the-difference-between-x-509-and-pkcs7-certificate) ❗!important
...
PEM (Privacy Enhanced Mail) base64 DER, with text headers and footers, can be `CERTIFICATE`, `CERTIFICATE REQUEST`, `PRIVATE KEY`, `PUBLIC KEY`, `X509 CRL`
File extensions: `.pem`, `.key`, `.pub`, `.csr`, `.cer`, `.crt`
DER (Distinguished Encoding Rules), binary without text headers and footers
File extensions: `.der`, `.cer`, `.crt`
PKCS (Public-Key Cryptography Standards)
File extensions: `.p7b` (PKCS#7/CMS), `.pfx`, `.p12` (PKCS#12 binary), `.p10`/`.csr` (PKCS#10 base64), `.req` (PKCS#10)
...
[Survival Guide - TLS/SSL and SSL (X.509) Certificates (CA-signed and Self-Signed)](http://www.zytrax.com/tech/survival/ssl.html) ❗!important
...
[ssl - How to create a self-signed certificate with openssl? - Stack Overflow](https://stackoverflow.com/questions/10175812/how-to-create-a-self-signed-certificate-with-openssl)
[OpenSSL CSR Tool - Create Your CSR Faster | DigiCert.com](https://www.digicert.com/easy-csr/openssl.htm)

[How To Create a Self-Signed SSL Certificate for Nginx in Ubuntu | DigitalOcean](https://www.digitalocean.com/community/tutorials/how-to-create-a-self-signed-ssl-certificate-for-nginx-in-ubuntu) not using SAN

Modern TLS clients uses Subject Alternate Name (SAN) instead of Common Name (CN) in distinguished name (server identity)
[Fixing Chrome 58+ [missing_subjectAltName] with openssl when using self signed certificates | Alexander Zeitler](https://alexanderzeitler.com/articles/Fixing-Chrome-missing_subjectAltName-selfsigned-cert-openssl/) root + server certs, SAN
[Manage sensitive data with Docker secrets | Docker Documentation](https://docs.docker.com/engine/swarm/secrets/#intermediate-example-use-secrets-with-a-nginx-service) CSR, root + server certs, SAN, `docker secret` only for Docker Swarm
[How can I generate a self-signed SSL certificate using OpenSSL? - Stack Overflow](https://stackoverflow.com/a/27931596) CSR and cert, SAN
[CITRIX | Support](https://support.citrix.com/support-home/kbsearch/article?articleNumber=CTX135602) SAN
[How to Create Self-Signed Certificate With Extensions and Sans Using Openssl](https://help.salesforce.com/s/articleView?id=001115354&type=1) single cert, SAN

```sh
# view
openssl x509 -text -noout -in ./conf/server.crt
openssl x509 -text -noout -in ./ssl/rootCA.pem
# verify
openssl verify -show_chain -CAfile ./ssl/rootCA.pem ./conf/server.crt

curl --cacert ./ssl/rootCA.pem https://self-signed.example.com
```

```sh
# OLD instructions, not using SAN

# private key and cert (CSR in the pipeline)
openssl req -x509 -nodes -days 3650 -newkey rsa:2048 -keyout privatekey.pem -out selfsigned.crt
...
[Corollarium/localtls: DNS server for providing TLS to webservices on local addresses](https://github.com/Corollarium/localtls)
...
openssl rsa -text -noout -RSAPublicKey_in -in public.key
```
