...
[The deepest problem with deep learning – Gary Marcus – Medium](https://medium.com/@GaryMarcus/the-deepest-problem-with-deep-learning-91c5991f5695)
...
[【亦】唠唠 AlphaCode：AI 会写代码了，人类怎么办？2022 新年闲唠 - YouTube](https://www.youtube.com/watch?v=DZs1BHIWubc) AI cannot "think different"
...
[Project Malmo - Microsoft Research](https://www.microsoft.com/en-us/research/project/project-malmo/)
...
[How Neural Networks Actually Work — Python Implementation (Simplified) | by Kiprono Elijah Koech | May, 2022 | Towards Data Science](https://towardsdatascience.com/how-neural-networks-actually-work-python-implementation-simplified-a1167b4f54fe)
...
[Interpretability Beyond Feature Attribution: Quantitative Testing with Concept Activation Vectors (TCAV) – Google AI](https://ai.google/research/pubs/pub47077)
...
[Model Server: The Critical Building Block of MLOps – The New Stack](https://thenewstack.io/model-server-the-critical-building-block-of-mlops/)
...
[Machine Learning Deployment Platform for Enterprise — Seldon](https://www.seldon.io/)
...
[Getting Started with TensorFlow 2.0 (Google I/O'19) - YouTube](https://www.youtube.com/watch?v=lEljKc9ZtU8)
[Python TensorFlow for Machine Learning – Neural Network Text Classification Tutorial - YouTube](https://www.youtube.com/watch?v=VtRLrQ3Ev-U) 2022

[Python is Insufficient for Data Science! That's Why Google has Swift](https://www.analyticsinsight.net/python-is-insufficient-for-data-science-thats-why-google-has-swift/)
...
[How to check CUDA version in TensorFlow - gcptutorials](https://www.gcptutorials.com/article/how-to-check-cuda-version-in-tensorflow)
...
[TensorFlow.js puts machine learning in the browser | InfoWorld](https://www.infoworld.com/article/3305340/tensorflow/tensorflowjs-puts-machine-learning-in-the-browser.html)
[First steps with TensorFlow.js - DEV Community 👩‍💻👨‍💻](https://dev.to/aralroca/first-steps-with-tensorflowjs-197p)
...
[Play Street Fighter with body movements using Arduino and Tensorflow.js - DEV Community 👩‍💻👨‍💻](https://dev.to/devdevcharlie/play-street-fighter-with-body-movements-using-arduino-and-tensorflow-js-4kbi)
[Google’s Deeplearn.js brings machine learning to the browser | InfoWorld](https://www.infoworld.com/article/3216464/machine-learning/googles-deeplearnjs-brings-machine-learning-to-the-browser.html)
[Let's build a game with Tensorflow.js in 10 minutes 🎮 - DEV Community 👩‍💻👨‍💻](https://dev.to/yashints/let-s-build-a-game-with-tensorflow-js-in-10-minutes-1co5)
[Optimizing Face Detection on your browser with Tensorflow.js | by Siddhant Baldota | Towards Data Science](https://towardsdatascience.com/face-detection-on-the-browser-with-tensorflow-js-27846a5fe954)

### Ecosystem

[Keras](https://keras.io/) building neural network
[Code examples](https://keras.io/examples/)
[An Introduction to Keras Preprocessing Layers — The TensorFlow Blog](https://blog.tensorflow.org/2021/11/an-introduction-to-keras-preprocessing.html)
[First contact with Deep Learning, practical introduction with Keras](https://torres.ai/first-contact-deep-learning-practical-introduction-keras/) free ebook
...
[Keras Learning Rate Finder - PyImageSearch](https://www.pyimagesearch.com/2019/08/05/keras-learning-rate-finder/)
[4 Awesome things you can do with Keras and the code you need to make it happen](https://towardsdatascience.com/4-awesome-things-you-can-do-with-keras-and-the-code-you-need-to-make-it-happen-858f022eec85)
[Building a Deep Image Search Engine using tf.Keras - Towards Data Science](https://towardsdatascience.com/building-a-deep-image-search-engine-using-tf-keras-6760beedbad)
...
[Project Bonsai for autonomous systems – Microsoft AI](https://www.microsoft.com/en-us/ai/autonomous-systems-project-bonsai)
[New AI language hides TensorFlow complexity | InfoWorld](http://www.infoworld.com/article/3190164/application-development/new-ai-language-hides-tensorflow-complexity.html)

[Your CPU supports instructions that this TensorFlow binary was not compiled to use: AVX AVX2 - Stack Overflow](https://stackoverflow.com/questions/47068709/your-cpu-supports-instructions-that-this-tensorflow-binary-was-not-compiled-to-u)
[Bash script for local building TensorFlow on Mac/Linux with all CPU optimizations (default pip package has only SSE)](https://gist.github.com/venik/9ba962c8b301b0e21f99884cbd35082f)
[lakshayg/tensorflow-build: TensorFlow binaries supporting AVX, FMA, SSE](https://github.com/lakshayg/tensorflow-build)

[TFX | TensorFlow](https://www.tensorflow.org/tfx) TensorFlow Extended (TFX) is an end-to-end platform for deploying production ML pipelines
[TensorBoard | TensorFlow](https://www.tensorflow.org/tensorboard)
[TensorBoard.dev - Upload and Share ML Experiments for Free](https://tensorboard.dev/)
[Tensorboard Tutorial - Visualize the Model Performance During Training](https://analyticsindiamag.com/tensorboard-tutorial-visualize-the-model-performance-during-training/)
...
[sicara/tf-explain: Interpretability Methods for tf.keras models with Tensorflow 2.0](https://github.com/sicara/tf-explain)
...
[Opinionated and open machine learning: The nuances of using Facebook's PyTorch | ZDNet](https://www.zdnet.com/article/opinionated-openness-facebook-ai-research-strategy-ecosystem-and-target-audience-for-deep-learning/)
[A first look at Pytorch 1.0 – Towards Data Science](https://towardsdatascience.com/a-first-look-at-pytorch-1-0-8d3cce20b3ee)
...
[Training an object detector from scratch in PyTorch - PyImageSearch](https://www.pyimagesearch.com/2021/11/01/training-an-object-detector-from-scratch-in-pytorch/)
...
[Fast.ai's software could radically democratize AI | ZDNet](https://www.zdnet.com/article/fast-ais-new-software-could-radically-democratize-ai/)
do for PyTorch what Keras did for TensorFlow

[Announcing TorchServe, An Open Source Model Server for PyTorch | AWS News Blog](https://aws.amazon.com/es/blogs/aws/announcing-torchserve-an-open-source-model-server-for-pytorch/)
...
[Welcome — Theano documentation](http://deeplearning.net/software/theano/)
...
[amznlabs/amazon-dsstne: Deep Scalable Sparse Tensor Network Engine (DSSTNE) is an Amazon developed library for building Deep Learning (DL) machine learning (ML) models](https://github.com/amznlabs/amazon-dsstne)
...
> [Caffe2 and PyTorch join forces to create a Research + Production platform PyTorch 1.0 | Caffe2](https://caffe2.ai/blog/2018/05/02/Caffe2_PyTorch_1_0.html)
...
[How to Speed Up Deep Learning Inference Using TensorRT | NVIDIA Developer Blog](https://devblogs.nvidia.com/speed-up-inference-tensorrt/) introductory blog post
[TensorRT 4 Accelerates Neural Machine Translation, Recommenders, and Speech | NVIDIA Developer Blog](https://devblogs.nvidia.com/tensorrt-4-accelerates-translation-speech-recommender/)
[NVidia 2017 - Washington D.C.](http://on-demand.gputechconf.com/gtcdc/2017/video/DC7172/)
[Accelerating Inference In TF-TRT User Guide :: Deep Learning Frameworks Documentation](https://docs.nvidia.com/deeplearning/frameworks/tf-trt-user-guide/index.html)
[tensorflow/tensorrt: TensorFlow/TensorRT integration](https://github.com/tensorflow/tensorrt)
[NVIDIA-AI-IOT/tf_trt_models: TensorFlow models accelerated with NVIDIA TensorRT](https://github.com/NVIDIA-AI-IOT/tf_trt_models)

[Object Detection on GPUs in 10 Minutes | NVIDIA Developer Blog](https://devblogs.nvidia.com/object-detection-gpus-10-minutes/)

## TensorFlow lite

[TensorFlow Lite | TensorFlow](https://www.tensorflow.org/lite)
[TensorFlow Lite converter | TensorFlow Lite | TensorFlow](https://www.tensorflow.org/lite/convert)

[How to Deploy Machine Learning Models on Mobile and Embedded Devices](https://www.freecodecamp.org/news/machine-learning-for-mobile-and-embedded-devices/amp/)
[Comparing MobileNet Models in TensorFlow | by Harshit Dwivedi | Heartbeat](https://heartbeat.comet.ml/exploring-the-mobilenet-models-in-tensorflow-d9d21774cdab)

[A Beginner’s Introduction To TensorFlow Lite - Towards Data Science](https://towardsdatascience.com/a-beginners-introduction-to-tensorflow-lite-924320deed5)
...
[PINTO0309/Tensorflow-bin: Prebuilt binary with Tensorflow Lite enabled (native build). For RaspberryPi / Jetson TX2 / Jetson Nano. And, solved Tensorflow issues #15062,#21574,#21855,#23082,#25120,#25748.](https://github.com/PINTO0309/Tensorflow-bin)

### Google AIY

[AIY Projects](https://aiyprojects.withgoogle.com/)
[Voice](https://aiyprojects.withgoogle.com/voice/) requires Google Assistant
[Vision](https://aiyprojects.withgoogle.com/vision/#more-info--system-updates)
[google/aiyprojects-raspbian: API libraries, samples, and system images for AIY Projects (Voice Kit and Vision Kit)](https://github.com/google/aiyprojects-raspbian)

[Hacking the Google AIY Voice Kit - Part 1 - YouTube](https://www.youtube.com/watch?v=jQK0VDWIzus)
[Hacking the Google AIY Voice Kit Part 2 - Voice Control - YouTube](https://www.youtube.com/watch?v=GI8zU_HO8CA)

[Voice](https://aiyprojects.withgoogle.com/voice/)
[Google AIY Voice Kit for Raspberry Pi ID: 3602 - \$24.95 : Adafruit Industries, Unique & fun DIY electronics and kits](https://www.adafruit.com/product/3602)

[How to build a smart RasPi Bot with Cloud Vision and Speech API - Google I/O 2016 - YouTube](https://www.youtube.com/watch?v=HpPyhsC4q9M)

## Federated Learning

[NVIDIA FLARE — NVIDIA FLARE 2.2.1 documentation](https://nvflare.readthedocs.io/en/2.2.1/)
[NVIDIA/NVFlare: NVIDIA Federated Learning Application Runtime Environment](https://github.com/NVIDIA/NVFlare)

## Coral USB Accelerator/TPU

[Google Details Tensor Chip Powers IEEE Spectrum - IEEE Spectrum](https://spectrum.ieee.org/tech-talk/computing/hardware/google-details-tensor-chip-powers)

[Coral](https://coral.ai/)
[Documentation | Coral](https://coral.ai/docs/)
[Google Developers Blog: Coral moves out of beta](https://developers.googleblog.com/2019/10/coral-moves-out-of-beta.html)
[Google Developers Blog: Coral moves out of beta](https://developers.googleblog.com/2019/10/coral-moves-out-of-beta.html)
...
[Neural Style Transfer with OpenVINO™ Toolkit - Intel Software Innovators - Medium](https://medium.com/intel-software-innovators/neural-style-transfer-with-open-vino-toolkit-b56ae7c6a2c)
...
[TinyML is giving hardware new life – TechCrunch](https://techcrunch.com/2020/05/29/tinyml-is-giving-hardware-new-life/amp/)

[SparkFun Edge Development Board - Apollo3 Blue - DEV-15170 - SparkFun Electronics](https://www.sparkfun.com/products/15170)
[Adafruit EdgeBadge - TensorFlow Lite for Microcontrollers ID: 4400 - \$35.95 : Adafruit Industries, Unique & fun DIY electronics and kits](https://www.adafruit.com/product/4400)
[ESP-EYE Overview | Espressif Systems](https://www.espressif.com/en/products/devkits/esp-eye/overview)
...
[Deploy machine learning models in production - Cortex](https://www.cortex.dev/)
[cortexlabs/cortex: Cloud native model serving infrastructure](https://github.com/cortexlabs/cortex)
...
[NVIDIA TensorRT Inference Server Boosts Deep Learning Inference | NVIDIA Developer Blog](https://devblogs.nvidia.com/nvidia-serves-deep-learning-inference/) introductory blog post
[NVIDIA TensorRT Inference Server — NVIDIA TensorRT Inference Server documentation](https://docs.nvidia.com/deeplearning/sdk/tensorrt-inference-server-guide/docs/)
[NVIDIA/tensorrt-inference-server: The TensorRT Inference Server provides a cloud inferencing solution optimized for NVIDIA GPUs.](https://github.com/NVIDIA/tensorrt-inference-server)
...
[10 Machine Learning Examples in JavaScript - Tutorialzine](https://tutorialzine.com/2017/04/10-machine-learning-examples-in-javascript)
[JavaScript and machine learning: Google shows what's possible using the web programming language - TechRepublic](https://www.techrepublic.com/google-amp/article/google-shows-off-whats-possible-using-the-javascript-programming-language-for-machine-learning/)
[AI in browsers: Comparing TensorFlow, ONNX, and WebDNN for image classification - LogRocket Blog](https://blog.logrocket.com/ai-in-browsers-comparing-tensorflow-onnx-and-webdnn-for-image-classification/)
[4 reasons to learn machine learning with JavaScript | VentureBeat](https://venturebeat.com/2021/04/23/4-reasons-to-learn-machine-learning-with-javascript/)
...
[Neural Networks in JavaScript with deeplearn.js - RWieruch](https://www.robinwieruch.de/neural-networks-deeplearnjs-javascript/)
...
[Why you should use Python for machine learning | InfoWorld](https://www.infoworld.com/article/3269316/python/why-you-should-use-python-for-machine-learning.html)
[5 Python distributions for mastering machine learning | InfoWorld](https://www.infoworld.com/article/3279544/python/5-python-distributions-for-machine-learning.html)

[scikit-learn: machine learning in Python](http://scikit-learn.org/stable/) non neural
[Basic Machine Learning with SciKit-Learn | Graham Wheeler's Random Forest](https://www.grahamwheeler.com/posts/basic-machine-learning.html)
[Easily visualize Scikit-learn models’ decision boundaries](https://towardsdatascience.com/easily-visualize-scikit-learn-models-decision-boundaries-dd0fb3747508)
...
[The Microsoft Infer.NET machine learning framework goes open source - Microsoft Research](https://www.microsoft.com/en-us/research/blog/the-microsoft-infer-net-machine-learning-framework-goes-open-source/)

---

## Pokedex with AI

[Using TensorFlow Lite and ML Kit to Build a “Pokédex” in Android | by Harshit Dwivedi | Heartbeat](https://heartbeat.comet.ml/building-pok%C3%A9dex-in-android-using-tensorflow-lite-and-firebase-cc780848395)
[the-dagger/Pokidex: Android app that identifies and detects Pokemons in the provided Image using Tensorflow Lite and Firebase MLKit](https://github.com/the-dagger/Pokidex)
