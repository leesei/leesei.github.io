...
[All useEffect Mistakes Every Junior React Developer Makes - YouTube](https://www.youtube.com/watch?v=QQYeipc_cik)
...
[Page Scroll to Top – How to Scroll to a Particular Section with React](https://www.freecodecamp.org/news/scroll-to-top-bottom-and-particular-section-with-react/)
...
[naisutech/react-tree: Hierarchical tree component for React in Typescript](https://github.com/naisutech/react-tree)
...
[How to Create a CSS-Only Loader Using One Element](https://www.freecodecamp.org/news/how-to-create-a-css-only-loader/)
...
[Aljullu/react-lazy-load-image-component: React Component to lazy load images and components using a HOC to track window scroll position.](https://github.com/Aljullu/react-lazy-load-image-component#readme)
...
[Getting Started with Rich Text Editors in React | by Noah Blumenstein | Feb, 2022 | Bits and Pieces](https://blog.bitsrc.io/getting-started-with-rich-text-editors-in-react-aeb7112c68d5)
[Draft.js · Rich Text Editor Framework for React](https://draftjs.org/)
[sstur/react-rte: Pure React rich text WYSIWYG editor based on draft-js.](https://github.com/sstur/react-rte)
...
[22 Miraculous Tools for React Developers in 2019 | by jsmanifest | Better Programming](https://betterprogramming.pub/22-miraculous-tools-for-react-developers-in-2019-7d72054e2306)
[react-easy-edit](https://giorgosart.gitbook.io/react-easy-edit/) inline edit
[giorgosart/react-easy-edit: Inline editing library for React](https://github.com/giorgosart/react-easy-edit)

> see wordpress.md#wordpress-gutenberg`

Context Menu:
[React ContextMenu](https://vkbansal.github.io/react-contextmenu/#/)
[https://react-bootstrap.github.io/react-overlays/api/Dropdown](https://react-bootstrap.github.io/react-overlays/api/Dropdown)
...
[react-big-calendar | gcal/outlook like calendar component](https://jquense.github.io/react-big-calendar/)
...
[React Spaces - allaneagle.com](https://allaneagle.com/projects/react-spaces)
[React-Grid-Layout - Showcase](https://react-grid-layout.github.io/react-grid-layout/)
...
Table/Date Grid:
[TanStack Table | React Table, Solid Table, Svelte Table, Vue Table](https://tanstack.com/table/v8) React Table -> Tanstack Tables (multi-frameworks)
[5 Years of Building React Table – Tanner Linsley, React Summit 2022 - YouTube](https://www.youtube.com/watch?v=O4IWJcafX8c) [Theo's reposnse](https://www.youtube.com/watch?v=aFCxPo0kOGk)
...
[react-responsive-carousel.js.org](http://react-responsive-carousel.js.org/) decent customization, easy to use, can create presentation
...
[Build an elegant gallery with React-Responsive-Carousel](https://blog.openreplay.com/build-an-elegant-gallery-with-react-responsive-carousel)

[nuka-carousel](https://formidable.com/open-source/nuka-carousel/)
...
[React Pretty Carousel](https://react-pretty-carousel.herokuapp.com/) normal/gallery mode, imperitve functions
...
[ghoshnirmalya/react-search-box: An autocomplete search box built with and for React](https://github.com/ghoshnirmalya/react-search-box)
...
[What’s new in React Hook Form V7 - LogRocket Blog](https://blog.logrocket.com/whats-new-in-react-hook-form-v7/) `useForm<FormValues>()`
...
[Create Dynamic Forms in React Using React Hook Forms](https://www.syncfusion.com/blogs/post/create-dynamic-forms-in-react-using-react-hook-forms.aspx/amp)
[SyncfusionExamples/dynamic-forms-in-react-using-react-hook-forms](https://github.com/SyncfusionExamples/dynamic-forms-in-react-using-react-hook-forms)
...
[www.reactjsx.com](http://www.reactjsx.com/) Search reusable React components
...
[Using Mantine with React and Next](https://blog.openreplay.com/using-mantine-with-react-and-next)
...
[Build a component library with React and TypeScript - LogRocket Blog](https://blog.logrocket.com/build-component-library-react-typescript/)
...
[Building reusable UI components with React Hooks - LogRocket Blog](https://blog.logrocket.com/building-reusable-ui-components-with-react-hooks/)
[Creating shareable React widgets - LogRocket Blog](https://blog.logrocket.com/creating-shareable-react-widgets/)

[React Cosmos](https://reactcosmos.org/) Sandbox for developing and testing UI components in isolation
[react-cosmos/react-cosmos: Sandbox for developing and testing UI components in isolation](https://github.com/react-cosmos/react-cosmos)
...
[React Charts - Simple, immersive & interactive charts for React](https://react-charts.tanstack.com/)
[TanStack/react-charts: ⚛️ Simple, immersive & interactive charts for React](https://github.com/TanStack/react-charts)
...
[Build strongly typed polymorphic components with React and TypeScript - LogRocket Blog](https://blog.logrocket.com/build-strongly-typed-polymorphic-components-react-typescript/) [source](https://github.com/ohansemmanuel/polymorphic-react-component)
...
[Hyperscript - the hidden language of React - DEV Community](https://dev.to/fromaline/hyperscript-the-hidden-language-of-react-3d1f)
...
[Why you have to use className in React, but not in Preact? - DEV Community](https://dev.to/fromaline/why-you-have-to-use-classname-in-react-but-not-in-preact-3fdm)
...
JSX must return a _single_ element (use `<div>`/`<Fragment>` to wrap list).
...
[Become a JavaScript Testing Pro: 14 Resources for Developers - DEV Community 👩‍💻👨‍💻](https://dev.to/mbarzeev/become-a-javascript-testing-pro-14-resources-for-developers-4pkm)
...
[Replacing Enzyme with React Testing Library](https://wanago.io/2022/04/04/enzyme-react-testing-library/)
[Time to say goodbye - Enzyme.js | Piotr Staniów](https://www.piotrstaniow.pl/goodbye-enzyme)
