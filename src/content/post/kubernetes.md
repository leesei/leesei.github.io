...
[Kubernetes-Intro – WirelessMoves](https://blog.wirelessmoves.com/tag/kubernetes-intro)
...
[Kubernetes and Databases: Deploying Database on Kubernetes with StatefulSets](https://www.magalix.com/blog/kubernetes-and-database)
...
[Documentation | kube-vip](https://kube-vip.io/) load balancer for both services and control plane
...
[Wildcard Certificates with Traefik + cert-manager + Let's Encrypt in Kubernetes Tutorial - YouTube](https://www.youtube.com/watch?v=G4CmbYL9UPg)
[Wildcard Certificates with Traefik + cert-manager + Let's Encrypt in Kubernetes Tutorial | Techno Tim Documentation](https://docs.technotim.live/posts/kube-traefik-cert-manager-le/)

[Configuring Traefik 2 Ingress for Kubernetes | Techno Tim Documentation](https://docs.technotim.live/posts/k3s-traefik-rancher/)
...
[projectcontour/contour: Contour is a Kubernetes ingress controller using Lyft's Envoy proxy.](https://github.com/projectcontour/contour)
...
[projectcontour/gimbal: Gimbal is an ingress load balancing platform capable of routing traffic to multiple Kubernetes and OpenStack clusters. Built by Heptio in partnership with Actapio.](https://github.com/projectcontour/gimbal)
[gimbal/gimbal-architecture.md at master · projectcontour/gimbal](https://github.com/projectcontour/gimbal/blob/master/docs/gimbal-architecture.md)
...
[Try this Kubernetes HTTP router and reverse proxy | Opensource.com](https://opensource.com/article/20/4/http-kubernetes-skipper)
...
[Kubernetes Scheduler 101](https://www.magalix.com/blog/kubernetes-scheduler-101?hs_amp=true)

[Assigning Pods to Nodes | Kubernetes](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#node-affinity-beta-feature) attract pods
[Taints and Tolerations | Kubernetes](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/) taints prevents pods from scheduled, tolerations add whitelist to pods
[Kubernetes - Taints and Tolerations - The IT Hollow](https://theithollow.com/2019/07/29/kubernetes-taints-and-tolerations/)
...
[ClusterAPI — A Guide on How to Get Started | by Katie Gamanji | Product and Engineering at Condé Nast | Medium](https://medium.com/condenastengineering/clusterapi-a-guide-on-how-to-get-started-ff9a81262945)
